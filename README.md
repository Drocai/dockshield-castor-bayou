...
This repo is in **Phase 2: shared targeting v0, continuous Reel feedback, water pressure, boat prototype foundations, first Fly recon foundations, first Lilly bind foundations, three-hero character switching v0, first visual style pass v1, Reel static proxy review, beta meta systems, Bayou Mutation enemy combat and combat feedback v0, Deep Dock boss combo foundations, and Duct legendary encounter v0**.
